...
2. Download the memo.
   ...
   ```
3. Read the memo: one page on the shop's November results, written from the data file. Then ask the agent, in your own words, to check it against the data. Keep what you typed.
