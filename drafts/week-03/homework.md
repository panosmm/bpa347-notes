...
1. The question, exactly as written, nothing added:
   ...
   ```
2. Open your web browser and go to claude.ai. Start a new chat. Click the `+` button at the bottom left and choose **Research**. Paste the question and send it. Codex: in the browser, on chatgpt.com, click `+` and choose **Deep research**. Before it starts, it will probably ask you what exactly you want. If it does, reply "You decide, go ahead." This first report has to come from the question alone. It runs for some minutes. Wait for it to finish.
